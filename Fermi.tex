...
\begin{titlepage}
	...
	{\huge\bfseries Progetto FERMI\par}
        ...
        \vspace{2cm}
        \abstract{La seguente la lista provvisoria del database del progetto Fermi in attesa che risolviamo alcuni problemi tecnici. Alla fine del documento vi sono i link corrispondenti ad ognuna delle entrate}
	\vfill
